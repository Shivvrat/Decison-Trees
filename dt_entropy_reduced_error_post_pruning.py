...
def Information_Gain_Heuristic(examples, attributes, target_attribute):
    ...
    for each_attribute in attributes:
        ...
        # Here I concatinated the dataframes so that only one df is used to both lookup the value and find the value to append
...
"""
This function is used for the pruning of the tree and uses the validation data
"""
